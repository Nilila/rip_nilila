...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Rip_nilila chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Rip_nilila", HidePremium = false, IntroText = "Rip_nilila⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Rip_nilila SCRIPT")
W:AddLabel("DiscordRip_nilila")
local Section = W:AddSection({
    Name = "Status"
})
